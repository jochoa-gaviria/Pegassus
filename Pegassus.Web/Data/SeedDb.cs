...
namespace Pegassus.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var owner = await CheckUserAsync("1010", "Juan", "Ochoa", "jochoa.gaviria@hotmail.com", "311 743 7028", "Carrera 49", "Owner");
            var admin = await CheckUserAsync("2020", "Jonathan", "Ospina", "jonathanospinac@gmail.com", "311 392 6724", "Calle 70", "Admin");
            var organizer = await CheckUserAsync("3030", "Jose David", "Ocampo", "davidocampo101@gmail.com", "300 295 5427", "Calle 26", "Organizer");
